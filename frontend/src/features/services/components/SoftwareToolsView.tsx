...
import { softwareTools, toolCategories, type SoftwareTool } from "@/src/features/services/data/softwareToolsData";
            ...
            <div className="ds-store-grid">
              {visibleTools.map((tool) => <article key={tool.id} className="ds-store-product-card">
                <div className="ds-store-product-head">
                  <div className="ds-store-logo"><img src={`https://cdn.simpleicons.org/${tool.logoSlug}/0f172a`} alt={`${tool.name} logo`} /></div>
